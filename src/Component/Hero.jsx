...
<section className="container md:flex md:justify-center md:items-center h-screen mb-24">
  <div className="md:w-6/12 w-full pl-4 pt-2 md:flex md:justify-center">
    <div className="h-5/6 w-full md:w-96 bg-white3 hover:shadow-2xl">
      <div className="flex justify-center">
        <img className="h-full md:h-5/6 pt-8 md:pt-24 pr-0 md:pr-16 w-full md:w-96" src={image} alt="" />
      </div>
    </div>
  </div>
  <div className="md:w-6/12 w-full my-2 pl-4">
    <div className="w-full md:w-10/12 md:text-left text-justify space-y-6">
      <p className="text-2xl md:text-4xl font-bold font-abc">Md Mehedi Hasan</p>
      <p className="text-xl md:text-3xl font-bold text-grey2 font-abc">
